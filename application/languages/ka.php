...
return array(
    ...
    'incbrowser_ie67_text' => '<p>;ძვირფასო მომხმარებელო, თქვენ იყენებთ მსოფლიოში ყველაზე მოძველებულ ბრაუზერს მაშინ როდესაც არსებობს; რამდენიმე შესანიშნავი ალტერნატივა;(<strong>მათ შორის თქვენი მიმდინარე ბრაუზერის მწარმოებლისგან</strong>). ;ამ საიტის სანახავად გირჩევთ გადმოწეროთ ქვემოთ მითითებულ ბრაუზერთაგან ერთერთი. ;გისურვებთ წარმატებულ მუშაობას!;</p>;<h2>გადმოწერეთ ერთერთი ბრაუზერი</h2>',
    'incbrowser_iemore7_text' => '<p>;ძვირფასო მომხმარებელო თქვენი ბრაუზერი არ <br/>;აკმაყოფილებს იმ მოთხოვნებს რაც საჭიროა ამ საიტის <br/>;სანახავად გთხოვთ მოახდინოთ მისი განახლება ან გამოიყენო<br/>;სხვა თანამედროვე ბრაუზერი!;</p>'
);
