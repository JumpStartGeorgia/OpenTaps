<div id='project_content' class="group" style="margin-bottom: 16px;">
	...
	<div class='group'>
		...
		<div id='map' style="width:382px; border:1px dotted #a6a6a6; border-top: 0; height: 221px; float:left;"></div>
		
		<div id='project_details' style='width: 288px; min-height: 15px; max-height: 244px; border-bottom: 0px;'>
			...
			<?php if (!empty($region['cities']) AND strlen($region['cities']) > 0): ?>
			<div class='project_details_line'>
				<div class='line_left'>
					<?php echo l('region_cities') ?> :
				</div>
				<div>
					<?php echo $region['cities']; ?>
				</div>
			</div>
			<?php endif; ?>
			<?php if (!empty($region['towns']) AND strlen($region['towns']) > 0): ?>
			<div class='project_details_line'>
				<div class='line_left'>
					<?php echo l('region_towns') ?> :
				</div>
				<div>
					<?php echo $region['towns']; ?>
				</div>
			</div>
			<?php endif; ?>
