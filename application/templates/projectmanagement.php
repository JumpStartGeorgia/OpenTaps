...
<div style="border:0px solid #000;width:500px;height:auto;">
	...
	<?php foreach($projects as $project): ?>
		<tr>
			...
			<td><a href="<?php echo href("admin/projmanagement/{$project['id']}/edit") ?>">edit</a></td>
			<td><a href='<?php echo href('admin/projmanagement-new/'.$project['id']) ?>'>edit tags</a></td>
			<td><a href="<?php echo href("admin/projmanagement/{$project['id']}/delete") ?>">delete</a></td>
		</tr>
