<?
  ...
  echo "
  	<form action='" . $action . "' method='post'>
  	    ...
  	    <input name='m_name' id='mname' type='text' value=\"" . $result['name'] . "\" /><br /><br />
  	    <label for='mshortname'>Short Name: </label><br />
  	    <input name='m_short_name' id='mshortname' type='text' value=\"" . $result['short_name'] . "\" /><br /><br />
	    <label for='mtitle'>Title:</label><br />
	    <input type='text' value='". $result['title'] ."' name='m_title' id='mtitle'/><br /><br />
	    <label for='mtext'>Text:</label><br />
	    <textarea name='m_text' id='mtext'>". $result['text'] ."</textarea><br /><br  />
  ";
  ...
  echo "
  	    <input type='submit' style='width:90px;' value='Submit' /><br /><br />
  	</form>
