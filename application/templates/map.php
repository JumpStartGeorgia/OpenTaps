<div id="map_and_menus" style="position: relative; cursor:pointer;">
                    <div id="map" style="height:360px;"></div>
                       <div onclick="$(this).fadeOut(function(){$(this).remove();});" style="position:absolute;top:0px;left:0px;z-index:6000;opacity:.25;height:362px;width:100.3%;background-color:#000;"></div>
