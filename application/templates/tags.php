    	...
    	<div class='group' id='titletype'>
    	    ...
    	    <?php $def = strtoupper($def); ?>
    	    	<a href='<?php echo href('tag/project/' . $tag_name, TRUE, 'tags') ?>'
    	    	   class='choosedef<?php ($def == "PROJECTS") AND print("_selected") ?>'>
    	    	   <?php echo strtoupper(l('tags_projects')) ?>
    	    	</a>
    	    	<a href='<?php echo href('tag/organization/' . $tag_name, TRUE, 'tags') ?>'
    	    	   class='choosedef<?php ($def == "ORGANIZATIONS") AND print("_selected") ?>'>
    	    	   <?php echo strtoupper(l('tags_organizations')) ?>
    	    	</a>
    	    	<a href='<?php echo href('tag/news/' . $tag_name, TRUE, 'tags') ?>'
    	    	   class='choosedef<?php ($def == "NEWS") AND print("_selected") ?>'>
    	    		<?php echo strtoupper(l('tags_news')) ?>
    	    	</a>
    	    </div>
    	</div>
